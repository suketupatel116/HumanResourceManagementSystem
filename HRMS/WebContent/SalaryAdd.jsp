<%@page import="com.pcube.admin.bean.PayrollBean" %>
...
<form action="SalaryAdd" method="post" name="SalaryAdd">
	...
	<div class="select_sub">
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li><a href="RegList" >View Employee Details</a></li>
			</ul>
		</div>
		...
		<ul class="current"><li><a href=" "><b>Payroll</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show" ><a href="SalaryAdd.jsp ">Add Payroll Details</a></li>
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="basic" value="<%=basic != null ? basic:"" %>" />
			<%=request.getAttribute("basic") != null ? request.getAttribute("basic"):""  %>
			</td>
		</tr>
		<tr>
			<th valign="top">HRA :</th>
			<td><input type="text" class="inp-form" name="HRA" value="<%=HRA != null ? HRA:"" %>" />
			<%=request.getAttribute("HRA") != null ? request.getAttribute("HRA"):""  %>
			</td>
		</tr>
		<tr>
			<th valign="top">TA :</th>
			<td><input type="text" class="inp-form" name="TA" value="<%=TA != null ? TA:"" %>" />
			<%=request.getAttribute("TA") != null ? request.getAttribute("TA"):""  %>
			</td>
		</tr>
		<tr>
			<th valign="top">PF :</th>
			<td><input type="text" class="inp-form" name="PF" value="<%=PF != null ? PF:"" %>" />
			<%=request.getAttribute("PF") != null ? request.getAttribute("PF"):""  %>
			</td>
		</tr>
	<tr>
		<th>&nbsp;</th>
