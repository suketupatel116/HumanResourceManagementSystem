...
<%@ page import="com.pcube.admin.bean.LeaveBean" %>
...
<%
	LeaveBean bean = (LeaveBean)request.getAttribute("bean");
	String username = "";
	String leavetype = "";
	String from = "";
	String to = "";
...
<tr>
	...
	<tr>
		<th valign="top">Leave Type :</th>
			<td><input type="text" class="inp-form" name="leavetype" value="<%=leavetype != null ? leavetype:"" %>" />
			<%=request.getAttribute("leavetype") != null ? request.getAttribute("leavetype"):""  %>		
		</td>
	</tr>
		
	<tr>
			<th valign="top">From :</th>
			<td><input type="text" class="inp-form" name="from" value="<%=from != null ? from:"" %>" />
			<%=request.getAttribute("from") != null ? request.getAttribute("from"):""  %>
			</td>
	...
	<tr>
			<th valign="top">To :</th>
			<td><input type="text" class="inp-form" name="to" value="<%=to != null ? to:"" %>" />
			<%=request.getAttribute("to") != null ? request.getAttribute("to"):""  %>
			</td>
	...
	<tr>
			...
			<td>
			<textarea name="remarks" rows="" cols="" class="form-textarea"></textarea>
