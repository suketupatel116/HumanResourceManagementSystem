...
<body>
<form action="Pro" method="post" name="Pro">
...
<div class="nav-outer"> 
	...
	<div class="select_sub">
		...
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href=" Pro.jsp">Add Project Details</a></li>
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="title" value="<%=title != null ? title:"" %>" />
	...
	<tr>
		<th valign="top">Client Name :</th>
			<td><input type="text" class="inp-form" name="cname" value="<%=cname != null ? cname:"" %>" />
			<%=request.getAttribute("cname") != null ? request.getAttribute("cname"):""  %>		
		</td>
	</tr>
		
	<tr>
			<th valign="top">Duration :</th>
			<td><input type="text" class="inp-form" name="duration" value="<%=duration != null ? duration:"" %>" />
			<%=request.getAttribute("duration") != null ? request.getAttribute("duration"):""  %>
			</td>
			
	</tr>
	
	<tr>
			<th valign="top">Project Leader :</th>
			<td><input type="text" class="inp-form" name="teamlead" value="<%=teamlead != null ? teamlead:"" %>" />
			<%=request.getAttribute("teamlead") != null ? request.getAttribute("teamlead"):""  %>
			</td>
