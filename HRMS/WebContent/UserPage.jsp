...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Welcome</title><link type="image/x-icon" rel="shortcut icon" href="https://people.zoho.com/people/images/People.ico"><link href="Zoho%20%20People_files/wmsbar.css" rel="stylesheet" type="text/css">
...
</div></div></div><div class="navbar" id="navbar"><div><!-- $Id$ -->
...
<li ><a href="RegUserView" title=" ">My Profile</a></li>
...
<div class="contR fn">
<div class="profileLft zc-componentBg">
  <h2 class="gshead">Welcome &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <%	String i = request.getParameter("i");
  		if(i != null){
  %><font color="red" size="7px">Data Updated Successfully</font>
  <%} %>
    <div class="gsstartup"></div>
  </h2>
<div class="gsimg"><img src="Zoho%20%20People_files/getstarted.png" border="0">
<a href="RegUserView" style="top:34px; left:125px">My Profile</a>
<a href="Leave.jsp" style="top:34px; left:422px">Apply Leave</a>
<a href="RegUserUpdate" id="gs_mydepartments" style="top:176px; left:16px">Edit Profile</a>
<a href="SalView.jsp" style="top:176px; left:502px">Payroll</a> 
<a href="ReportGen.jsp" style="top:328px; left:424px"> Report</a>
<a href="https://people.zoho.com/people/#leavetracker/holidays" style="top:328px; left:120px">Holidays List</a></div>
<div class="gsinfo"><div class="zpuser fl"></div><div class="gsinfoDiv">
  <div class="gslinks"></div>
</div></div></div></div><div class="contL fr"><div class="gsrgt"><div class="gsrgthead"><div class="zphelp fl mar5"></div>Looking for help?</div><div class="gstxt"><b>Contact Us</b> <br>
<a href="mailto:support@zohopeople.com">info@pcubesoftech.com</a></div><div class="gstxt"></div>
</div></div>


</div></div><div id="absolutedivs">
<div id="calendarcontent" style="display: none;"><div class="fl"><div class="zpclar fl" onclick="NewCalendar.previousMonth();"></div><div class="zpnavtxt" id="calmonth"></div><div class="zpcrar fl" onclick="NewCalendar.nextMonth();"></div></div><table class="zptcal" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>
<tr><td class="zpcalheadcol" style="border-right:none;" width="12%" align="center">Sun</td> 
<td class="zpcalheadcol" style="border-right:none;" width="12%" align="center">Mon</td> 
<td class="zpcalheadcol" style="border-right:none;" width="12%" align="center">Tue</td> 
<td class="zpcalheadcol" style="border-right:none;" width="12%" align="center">Wed</td> 
<td class="zpcalheadcol" style="border-right:none;" width="12%" align="center">Thu</td> 
<td class="zpcalheadcol" style="border-right:none;" width="12%" align="center">Fri</td> 
<td class="zpcalheadcol" style="border-right:none;" width="12%" align="center">Sat</td> 
<td class="zpcalheadcol zpcaltot" style="border-right:none;" width="12%" align="center">Total</td></tr></tbody> <tbody id="calbody">
<tr><td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">1</td> <td class="zpcaltotal" style="border-right:none;" valign="middle" align="center">&nbsp; </td></tr><tr><td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaltoday" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;<div class="zpatime"></div></td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaltotal" style="border-right:none;" valign="middle" align="center">&nbsp; </td></tr><tr><td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaltotal" style="border-right:none;" valign="middle" align="center">&nbsp; </td></tr><tr><td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaltotal" style="border-right:none;" valign="middle" align="center">&nbsp; </td></tr><tr><td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcaltotal" style="border-right:none;" valign="middle" align="center">&nbsp; </td></tr><tr><td class="zpcaldays" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcalempty" valign="top">&nbsp;</td> <td class="zpcaltotal" style="border-right:none;" valign="middle" align="center">&nbsp; </td></tr><tr><td colspan="7" class="zpcaltxt" style="border-bottom:none;" valign="middle"> <br><span> </span></td> <td class="zpcalgtotal" style="border-right:none; border-bottom:none;" id="caltotmont" valign="middle">&nbsp;</td></tr></tbody></table></div></div><div id="errorMsgDiv" class="errorBox" style="display: none"></div><div id="fetchfRecordDiv" style="display: none;"><div id="fetchfRecordinnerDiv" class="loading" style="position: fixed; bottom: 20px;"><p>Loading... <img style="position: relative; left: 10px; top: 1px;" src="Zoho%20%20People_files/loading.gif"></p></div></div><div style="display: none" id="infoMsgDiv" class="yellbox"></div><div class="zploading" id="zpeople_progressbar" style="display: none;">Loading...</div><div class="zpsuc" id="zpeople_successmsg" style="display: none"></div><div class="zploading" id="zpeople_warningmsg" style="display: none"></div><div class="zpalt" id="zpeople_failuremsg" style="display: none"></div><div id="employeeHoverBox" class="hoverBox"></div>
<div class="menu-div outerbox" id="popupdiv" style="position: absolute; top: 0pt; left: 0pt; display: none;"></div></div>
<div style="display: none;" class="wms-colpsbar" id="wmscollapsetbar"><img src="Zoho%20%20People_files/spacer.gif" class="wms-maxi" title="Restore"></div><div style="display: none;" class="wms-ttipdiv"></div>
<div onclick="this.style.display='none';" class="wms_cover" style="display: none;" id="wmscoverid"></div><div style="display: none;"><iframe name="wmspconnect" style="display:none;" id="pconnect" src="Zoho%20%20People_files/pconnect.htm"></iframe></div>
<!-- start footer -->         
<div id="footer">
	<!--  start footer-left -->
	<div id="footer-left">
