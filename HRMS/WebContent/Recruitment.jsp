...
<body>
<form action="Recruitment" method="post" name="Recruitment">
...
<div class="nav-outer"> 
	...
	<div class="select_sub">
		...
		<ul class="current"><li><a href=" "><b>Vacancy</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="Recruitment.jsp ">Add Vacancy Details </a></li>
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="experience" value="<%=experience != null ? experience:"" %>" />
			<%=request.getAttribute("experience")!= null ? request.getAttribute("experience"):""  %>
			</td>
		</tr>
		<tr>
			<th valign="top">Remarks:</th>
			<td>
			<textarea name="address" rows="" cols="" class="form-textarea"></textarea>
