...
<%@page import="com.pcube.admin.bean.ProjectBean"%>
...
<div class="nav-outer"> 
	...
	<div class="select_sub">
		...
		<ul class="current"><li><a href=" "><b>Projects</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li><a href=" Pro.jsp">Add Project Details</a></li>
				<li class="sub_show"><a href=" ProList">View Project Details </a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
