...
<div class="nav-outer"> 
	...
	<div class="select_sub">
		...
		<ul class="current"><li><a href=" "><b>Leave</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="LeaveList ">View Pending Leaves</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
...
<input type="hidden" name="hId" value="" />
	...
	<%
		...
		{
			LeaveBean bean = (LeaveBean)list.get(i);
			if(bean != null)
			{
	%>
	...
	<tr>
		<td><%=bean.getId()%></td>
            ...
            <td><%=bean.getLeavetype()%></td>
            <td><%=bean.getFrom()%></td>
            <td><%=bean.getTo()%></td>
			<td><%=bean.getRemarks()%></td>
		<td><input type="button" value="Delete" name="delete" onclick="deleteData('<%=bean.getId() %>')" /></td>
